...
def login():
    ...
    ################# Main Frame Code #############################################
    global login
    login = ImageTk.PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\Login, Registration Page\\pexels-lucie-liz-3165335.jpg")
...
def reg():
    ...
    global img
    img = ImageTk.PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\Login, Registration Page\\pexels-lucie-liz-3165335.jpg")
...
def openguess():
    ...
    global img
    img = PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\Shreyas\\shreyas.png")
    ...
    p2 = PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\Shreyas\\Play.gif")     
    ...
    p3 = PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\Shreyas\\Quit.png")     
...
def colorgame():
    ...
    def Game():
        ...
        Left = PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\Dhruvil\\Run.png")     
        canvas.create_image(0, 200, anchor="w", image=Left)
        
        global Right
        canvas = Canvas(Game, width = 400, height = 340, bg="#696868")      
        canvas.place(x=400, y=10) 
        Right = PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\Dhruvil\\Thanks.png")     
    ...
    global p1
    p1 = PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\Dhruvil\\Logo.png")
    ...
    p2 = PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\Dhruvil\\Play.gif")     
    canvas.create_image(-50,-40, anchor=NW, image=p2)
    ...
    p3 = PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\Dhruvil\\Quit.png")     
    canvas.create_image(-10, -10, anchor=NW, image=p3)
...
def opentictactoa():
    ...
    ##################### Images: #############################
    global img
    img = PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\Sumeet\\Logo.png")
    ...
    p2 = PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\Sumeet\\Play.gif")     
    canvas.create_image(-50,-40, anchor=NW, image=p2)
    ...
    p3 = PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\Sumeet\\Quit.png")     
    canvas.create_image(-10, -10, anchor=NW, image=p3)
...
def opencontent():
    ...
    global image1
    ############# Image: ########################################
    BG = ImageTk.PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\About\\pexels-lucie-liz-3165335.jpg")
    ...
    global a1
    a1 = PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\About\\Logo-3.png")
    ...
    global a2
    a2 = PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\About\\Logo-3.png")
    canvas = Canvas(About, width = 250, height = 270, bg="Cyan")      
    ...
    global a3
    a3 = PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\About\\Logo-2.png")
    canvas = Canvas(About, width = 250, height = 270, bg="Cyan")      
...
photo1 = PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\Homepage\\shreyas.png")
...
photo2 = PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\Homepage\\dhruvilcolorgame.png")
...
photo3 = PhotoImage(file = "D:\\Tkinter\\Main_Homepage\\Image\\Homepage\\images.png")
